...
// Program otel-collector-prosegur is an OpenTelemetry Collector binary.
package main
...
func main() {
	info := component.BuildInfo{
		Command:     "otel-collector-prosegur",
		Description: "OTel Collector con enrutador dinamico para OpenObserve",
		Version:     "",
	}
